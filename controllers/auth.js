    ...
    try {
        ...
        database.query('SELECT * FROM Users WHERE Email = ?', [username], async (error, results) => {
            ...
            if( !results || password != results[0].Password) {
                ...
                let matches = [
                    {FirstName: '', LastName: '', Email: '', Interest1: '', Interest2: '', Interest3: '', Interest4: '', Interest5: ''},
                    {FirstName: '', LastName: '', Email: '', Interest1: '', Interest2: '', Interest3: '', Interest4: '', Interest5: ''},
                    {FirstName: '', LastName: '', Email: '', Interest1: '', Interest2: '', Interest3: '', Interest4: '', Interest5: ''},
                    {FirstName: '', LastName: '', Email: '', Interest1: '', Interest2: '', Interest3: '', Interest4: '', Interest5: ''},
                    {FirstName: '', LastName: '', Email: '', Interest1: '', Interest2: '', Interest3: '', Interest4: '', Interest5: ''},
                                    ...
                                    <div id="Interests" class="Scrollbox">
                                        ...
                                        <table id="Users">
                                            ...
                                            <tr>
                                                ...
                                                <td>${matches[19].Email}</td>
                                            </tr>
                                            

                                        </table>
                                    </div>
                                    <form id="edit" action="/auth/edit" method="POST">
